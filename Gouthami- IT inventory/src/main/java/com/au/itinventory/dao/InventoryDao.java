...
public class InventoryDao {
	...
	public CountSummary getCountSummary(String itemName) {
		// TODO Auto-generated method stub
		int total=0;
		...
		countSummary.setAllocated(allocated);
		countSummary.setDefective(defective);
		countSummary.setInStock(inStock);
		countSummary.setTotal(total);
		return countSummary;
	}
