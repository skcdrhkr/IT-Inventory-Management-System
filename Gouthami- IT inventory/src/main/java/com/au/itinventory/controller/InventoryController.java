...
import com.au.itinventory.models.CountSummary;
...
public class InventoryController {
		...
		public ModelAndView fileUpload(@RequestParam("filePath") String filepath)
		{
			ModelAndView model=null;
		...
		@RequestMapping(value = "/countSummary", method = RequestMethod.GET)
		public CountSummary countSummary(@RequestParam("itemName") String itemName){
			//need to add required request params9
			CountSummary countSummary=inventoryService.getStatusSummary(itemName);
			System.out.println("Allocated"+countSummary.getAllocated());
			System.out.println("Defective"+countSummary.getDefective());
			System.out.println("Instock"+countSummary.getInStock());
			return countSummary;
		}
